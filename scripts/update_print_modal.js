...
const path = 'src/components/PPSPrintModal.tsx';
let content = fs.readFileSync(path, 'utf8');

// The replacement starts from `const renderChecklistRow` all the way to the end.
const newRenderChecklistRowAndReturn = `
        ...
        <div className="bg-gray-200 w-full p-4 md:p-8 flex flex-col items-center pb-20" ref={printRef}>
          ...
          <div className="pdf-page-element w-[800px] shrink-0 bg-white flex flex-col text-[10px] text-gray-800 font-sans border-t border-x border-gray-400 mb-0">
            ...
            <div className="flex border-b border-gray-400">
              <div className="w-[30%] flex flex-col items-start justify-center p-2 relative min-h-[90px] bg-gray-100 border-r border-gray-400">
                <img src="/logo.png" alt="FES Logo" className="max-h-[70px] object-contain" crossOrigin="anonymous" />
...
const startIndex = content.indexOf('const renderChecklistRow = (');
const endIndex = content.lastIndexOf('}');
if (startIndex !== -1 && endIndex !== -1) {
  content = content.substring(0, startIndex) + newRenderChecklistRowAndReturn + content.substring(endIndex + 1);
  fs.writeFileSync(path, content, 'utf8');
  console.log('Successfully updated PPSPrintModal.tsx');
} else {
